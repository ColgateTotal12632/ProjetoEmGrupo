...
namespace ProjetoDaora.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,Nome,Cpf,Telefone,DataCadastro")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,Nome,Cpf,Telefone,DataCadastro")] Vendedor vendedor)
        {
